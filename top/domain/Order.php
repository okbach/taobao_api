...
class Order
{
	 ...
	 * 激励订单完成时的预计佣金
	 **/
	public $estimated_incentive_finished_commission;
	
	/** 
	 * 激励订单支付时的预计佣金
	 **/
	public $estimated_incentive_paid_commission;
	 ...
	 * 激励佣金率
	 **/
	public $incentive_commission_rate;
	
	/** 
	 * 是否为联盟商品：N/Y
	 **/
	public $is_affiliate_product;
